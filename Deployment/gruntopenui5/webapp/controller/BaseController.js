sap.ui.define([
	...
	return Controller.extend("com.gruntopenui5.controller.BaseController", {
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(), "com.gruntopenui5.view.MessagePopover", this);
